...
impl RenderPass {
    ...
    pub fn new(
        ...
        web_sys::console::log_1(&"creating render pass".into());
        let vs_src = crate::include_shader!("gui.vert.spv");
        let vs_mod = device.create_shader_module(&vs_src);

        let fs_src = crate::include_shader!("gui.frag.spv");
        let fs_mod = device.create_shader_module(&fs_src);
        ...
        */
        ...
        web_sys::console::log_1(&"bind group layouts".into());
        ...
        web_sys::console::log_1(&"pipeline layout".into());
        ...
        web_sys::console::log_1(&"render pipeline".into());
